...
class AdminLayoutComposer
{
    ...
    private function nav(): array
    {
        return [
            ...
            [
                ...
                'label' => 'Content',
                'icon' => 'edit',
                'active' => request()->routeIs('pages.*', 'news.*', 'notices.*', 'events.*', 'alerts.*', 'media.*'),
                'items' => [
                    ...
                    ['Media Library', route('media.index'), 'folder', request()->routeIs('media.*')],
                ],
            ],
            [
                'type' => 'group',
            ...
            [
                ...
                'label' => 'Records',
                'icon' => 'folder',
                'active' => request()->routeIs('documents.*', 'document-categories.*', 'bids.*', 'jobs.*'),
                'items' => [
                    ['Document Library', route('documents.index'), 'archive', request()->routeIs('documents.*')],
                    ['Document Categories', route('document-categories.index'), 'folder', request()->routeIs('document-categories.*')],
    ...
    private function crumbs(View $view): array
    {
        ...
        $map = [
            ...
            'media' => ['Media Library', 'media.index'],
            ...
            'documents' => ['Document Library', 'documents.index'],
            'document-categories' => ['Document Categories', 'document-categories.index'],
