<x-layouts.public title="Report Submitted">
    ...
    <x-site.section :divider="false">
        <div class="mx-auto max-w-2xl">
            <div class="rounded-2xl bg-white p-8 ring-1 ring-slate-200 shadow-sm">
                <span class="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600 ring-1 ring-emerald-200">
